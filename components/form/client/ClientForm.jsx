...
export default function ClientForm ({children}) {
    ...
    return (
        <form className={"Form__form" + (isSubmiting ? " Form__form_submit" : "")} onSubmit={async (e)=>{
            e.preventDefault();
            let error = false;
            if (!check) {
            ...
            {children}
            <label htmlFor="name" className={"Form__form__input__error " + (errors.name ? "Form__form__input__error_show" : "")}>Неверный формат имени</label>
            ...
            <label htmlFor="email" className={"Form__form__input__error " + (errors.mail ? "Form__form__input__error_show" : "")}>Неверный формат почты</label>
            ...
            <label htmlFor="number" className={"Form__form__input__error " + (errors.phone ? "Form__form__input__error_show" : "")}>Неверный номер телефона</label>
            <MaskInput inputRef={phoneRef} error={errors.phone} setError={setErrors} className={"Form__form__input"} name={"number"} placeholder={"Номер телефон"} always={false}/>
