    ...
    return (
        <section className="Details">
            <div className="container">
                ...
                <div className="Details__split"><Ratingbar rating={data.rating} voices={data.voices} userrating={data.userrating} id={data.id} id2={data.image}/><p className="Details__split__p">{data.city}</p></div>
                <Image
                    src={"/img/"+data.image}
                    alt="image"
