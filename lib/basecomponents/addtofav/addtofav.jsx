...
export default function Addtofav ({id, title, article, image, mini = false, staronly = false}) {
    ...
    return (
        <div className={'Fav ' + (mini ? "Fav__mini " : "")} style={staronly ? {marginLeft: "10px", marginTop: "6px", marginRight: "0px"} : {}} onClick={()=>{
            if(!isLoad) {
                setLoad(true);
            ...
            <svg className="Fav__star" width="50" height="51" style={staronly ? {height: "20px", width: "20px"} : {}} viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
