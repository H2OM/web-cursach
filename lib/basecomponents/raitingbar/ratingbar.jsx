...
export default function Ratingbar ({rating, voices, id, id2, mini = false, userrating = false }) {
            ...
            <div className="Ratingbar__rait">
                {
                    Array.from({length: 5}).map((_, i)=>{
                        ...
                        return (
                            <svg role="svg" className={"Ratingbar__rait__star " + (selected >= (i+1) ? "Ratingbar__rait__star_full" : "")} width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg" key={i}
                                onMouseEnter={()=>{
